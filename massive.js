...
function VIII(){
    ...
    if (randomcamo < 2.70) {
        items.push('휴고 위장');
    } else if (randomcamo < 2.70 * 2) {
        items.push('아야메 위장');
    } else if (randomcamo < 2.70 * 3) {
        items.push('스카페이스 위장');
    } else if (randomcamo < 2.70 * 4) {
        items.push('Seeker 위장');
    } else if (randomcamo < 2.70 * 5) {
        items.push('대혼란 위장');
    } else if (randomcamo < 2.70 * 6) {
        items.push('Excalibur 위장');
    } else if (randomcamo < 2.70 * 7) {
        items.push('바이킹 위장');
    } else if (randomcamo < 2.70 * 8) {
        items.push('톱니 작살 괴수 위장');
    } else if (randomcamo < 2.70 * 9) {
        items.push('스테고사우루스 위장');
    } else if (randomcamo < 2.70 * 10) {
        items.push('Digitized 위장');
    } else if (randomcamo < 2.70 * 11) {
        items.push('삼엄한 경계 위장');
    } else if (randomcamo < 2.70 * 12) {
        items.push('팬텀 위장');
    } else if (randomcamo < 2.70 * 13) {
        items.push('신조 위장');
    } else if (randomcamo < 2.70 * 14) {
        items.push('Dignity 위장');
    } else if (randomcamo < 2.70 * 15) {
        items.push('스토커 위장');
    } else if (randomcamo < 2.70 * 16) {
        items.push('발명가 위장');
    } else if (randomcamo < 2.70 * 17) {
        items.push('맹위 위장');
    } else if (randomcamo < 2.70 * 18) {
        items.push('Kampe 위장');
    } else if (randomcamo < 2.70  * 19){
        items.push('독침 위장');
    } else if(randomcamo < 2.70 * 20){
        items.push('척탄병 위장');
    } else if(randomcamo < 2.70 * 21){
        items.push('불굴 위장');
    }else if(randomcamo < 2.70 * 22){
        items.push('Gongbi 위장');
    }else if(randomcamo < 2.70 * 23){
        items.push('Mechacamo 위장');
    }else if(randomcamo < 2.70 * 24){
        items.push('Spooky 위장');
    }else if(randomcamo < 2.70 * 25){
        items.push('모르포 위장');
    }else if(randomcamo < 2.70 * 26){
        items.push('Cannonball 위장');
    }else if(randomcamo < 2.70 * 27){
        items.push('누아르 위장');
    }else if(randomcamo < 2.70 * 28){
        items.push('상어 위장');
    }else if(randomcamo < 2.70 * 29){
        items.push('골렘 위장');
    }
